...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', 'M-S-n', function() harpoon:list():replace_at(1) end)
      vim.keymap.set('n', 'M-S-e', function() harpoon:list():replace_at(2) end)
      vim.keymap.set('n', 'M-S-i', function() harpoon:list():replace_at(3) end)
      vim.keymap.set('n', 'M-S-o', function() harpoon:list():replace_at(4) end)
    end,
  },
  {
    ...
    config = function()
      require('window-picker').setup {
        ...
        -- my keyboard is colemak, so I use these letters
        selection_chars = 'TNSERIAOPLFUWYQ:',
