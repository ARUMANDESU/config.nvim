...
-- window navigation uses vim's native Ctrl+W prefix (Ctrl is aerospace's plane)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set('n', '<C-s>', function() toggle_telescope(harpoon:list()) end, { desc = 'Open harpoon window' })
    end,
  },
